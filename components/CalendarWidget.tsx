  ...
  return (
    <div className="">
      ...
      <div className="flex flex-col  mt-2 shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)] h-[397px] rounded-3xl">
        <div id="calendar-header" className="h-20 max-h-20 flex-1 rounded-xl flex text-white bg-[#1C274C] shrink">
          <div className="flex text-[#A4A9B7] w-full">
            {dates.map((date, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`flex-1   text-xs gap-1 flex flex-col text-center items-center justify-center ${  index === activeItemIndex && 'bg-white font-bold text-[#1C274C] m-2 rounded-xl'}`}
